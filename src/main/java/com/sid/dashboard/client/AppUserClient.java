...
public class AppUserClient {
	...
	public List<Map<String, String>> fetchUsersClient(Object object, String path) {
		try {
	...
	public Response toggleAccountStatus(Map<String, String> requestBody, String path) {
		try {
			byte[] plainCredsBytes = Constants.AUTH.getBytes();
			String base64CredsBytes = Base64.getEncoder().encodeToString(plainCredsBytes);
	...
	public Response toggleOptOutStatus(Map<String, String> requestBody, String path) {
		try {
			byte[] plainCredsBytes = Constants.AUTH.getBytes();
			String base64CredsBytes = Base64.getEncoder().encodeToString(plainCredsBytes);
	...
	public List<Map<String, String>> fetchAppFeedbackClient(Object object, String path) {
		try {
			byte[] plainCredsBytes = Constants.AUTH.getBytes();
			String base64CredsBytes = Base64.getEncoder().encodeToString(plainCredsBytes);
