...
function overlib() {
	...
	if ( (ns4) || (ie4) || (ns6) ) {
		if (o3_over) cClick();
		o3_frame = ol_frame;
		if (ns4) o3_over = o3_frame.document.overDiv
		if (ie4) o3_over = o3_frame.overDiv.style
		if (ns6) o3_over = o3_frame.document.getElementById("overDiv");
	}
...
function nd() {
	...
	if ( (ns4) || (ie4) || (ns6) ) {
		if ( o3_showingsticky == 0 ) {
			o3_allowmove = 0;
			if (o3_over != null) hideObject(o3_over);
		} else {
			o3_removecounter++;
		}
	}
...
function set_background(pic) {
	if (pic == "") {
		if (ns4) o3_over.background.src = null;
		if (ie4) o3_over.backgroundImage = "none";
		if (ns6) o3_over.style.backgroundImage = "none";
	} else {
		if (ns4) {
			o3_over.background.src = pic;
		} else if (ie4) {
			o3_over.backgroundImage = "url("+pic+")";
		} else if (ns6) {
			o3_over.style.backgroundImage = "url("+pic+")";
		}
	}
}
...
function placeLayer() {
	...
	if (o3_fixy > -1) {
		...
		if (o3_vpos == ABOVE) {
			if (o3_aboveheight == 0) {
				var divref = (ie4) ? o3_frame.document.all['overDiv'] : o3_over;
	...
	repositionTo(o3_over, placeX, placeY);
}


// Moves the layer
function mouseMove(e) {
	//if (!e) return;   //abhay ... treatment for firefox
	if ( (ns4) || (ns6) ) { 
		if (e) {
...
function layerWrite(txt) {
	...
	if (ns4) {
		...
		range.setStartBefore(o3_over);
		domfrag = range.createContextualFragment(txt);
		while (o3_over.hasChildNodes()) {
			o3_over.removeChild(o3_over.lastChild);
		}
		o3_over.appendChild(domfrag);
	}
}
